    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="homepage-title-container">
                <hr/>
                    <h1 class="display heading" >Best Selling Products</h1>
                <hr/>
            </div>
            ...
            <div class="flex-row justify-content-around ">
                <div class="card index-product">
                    ...
                    <div class="card-body">
                        <h5 class="card-title item-name">Galaxy M31s</h5>
                        <p class="card-text item-price">$250</p>
                        <a href="#" class="btn btn-success btn-block cart-button">Add to Cart</a>
                        <a href="#" class="btn btn-outline-warning btn-block wishlist-button">Add to wishlist</a>
                    </div>
                </div>
                <div class="card index-product" >
                ...
                <div class="card index-product"  >
                    ...
                    <div class="card-body">
                        <h5 class="card-title item-name">iPhone 12</h5>
                        <p class="card-text item-price">$250</p>
                        <a href="#" class="btn btn-success btn-block cart-button">Add to Cart</a>
                        <a href="#" class="btn btn-outline-warning btn-block wishlist-button">Add to wishlist</a>
                    </div>
                ...
                <div class="card index-product" >
                    ...
                    <div class="card-body">
                        <h5 class="card-title item-name">Galaxy S10</h5>
                        <p class="card-text item-price">$250</p>
                        <a href="#" class="btn btn-success btn-block cart-button">Add to Cart</a>
                        <a href="#" class="btn btn-outline-warning btn-block wishlist-button">Add to wishlist</a>
                    </div>
